...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order_placed.create': { roles: ['pharmacy-manager', 'pharmacist'], key: 'order_id', tenantPath: [], userPath: [] },
  'inventory_updated.update': {
    roles: ['pharmacy-manager', 'pharmacist'],
    key: 'inventory_id',
    tenantPath: [],
    userPath: [],
  },
  'prescription_uploaded.create': {
    roles: ['pharmacy-manager', 'pharmacist'],
    key: 'prescription_id',
    tenantPath: [],
    userPath: [],
...
const ownerRoles: string[] = ['pharmacist'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['pharmacy-manager', 'pharmacist'];
